...
import EditPanel from '~/features/editor/menus/link-menu/edit-panel'
import PreviewPanel from '~/features/editor/menus/link-menu/preview-panel'

export const linkSchema = z.object({
  url: z.string().url('Please enter a valid URL!'),
})

export default function LinkMenu({ appendTo, editor }: { appendTo: React.RefObject<HTMLDivElement>; editor: Editor | null }) {
