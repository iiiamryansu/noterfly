...
import { ColumnLayout } from '~/components/editor/extensions/column'
import { getRenderContainer } from '~/components/editor/utils'
import { cn } from '~/utils'

export function ColumnMenu({ appendTo, editor }: { appendTo: RefObject<HTMLDivElement>; editor: Editor | null }) {
